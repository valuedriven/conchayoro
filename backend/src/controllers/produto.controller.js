...
exports.create = (req, res) => {
  ...
  Produto.create(produto)
    ...
    .catch((err) => {
      res.status(500).send({
        message: err.message || 'Erros ocorreram ao criar um produto.',
      });
    });
};
...
exports.findAll = (req, res) => {
  ...
  Produto.findAll({ where: condition })
    ...
    .catch((err) => {
      res.status(500).send({
        message: err.message || 'Erros ocorreram ao recuperar um produto.',
      });
    });
};
...
exports.findOne = (req, res) => {
  ...
  Produto.findByPk(id)
    ...
    .catch((err) => {
      res.status(500).send({
        message: err.message || 'Erro ao recuperar produto com id=' + id,
      });
    });
};
...
exports.delete = (req, res) => {
  ...
  Produto.destroy({
    ...
    .catch((err) => {
      res.status(500).send({
        message: err.message || 'Não foi possível deletar produto com id=' + id,
      });
    });
};
...
exports.deleteAll = (req, res) => {
  Produto.destroy({
    ...
    .catch((err) => {
      res.status(500).send({
        message: err.message || 'Erros ocorreram ao deletar todos produtos.',
      });
    });
};
